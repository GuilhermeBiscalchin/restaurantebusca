...
const Home = () => {
  ...
  return (
    <Wrapper>
      <Container>
        <Search>
          <Logo src={logo} alt="Restaurante Busca" />
          <TextField
            label="Busque aqui o Restaurante"
            outlined
              ...
              <Carousel {...settings}>
                {restaurants.map((restaurant) => (
                  <Card
                    ...
                    photo={
                      restaurant.photo ? restaurant.photo[0].getUrl() : fake
                    }
                  />
                ))}
              </Carousel>
      ...
      <Modal open={modalOpened} onClose={() => setModalOpened(!modalOpened)}>
        ...
        <ModalContent>
          {restaurantSelected?.opening_hoursw.open_now
            ? "Aberto Agora"
